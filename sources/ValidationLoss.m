...
switch params.Scales
    case 1
        [Yn0,state] = predict(net,Condiciones_Contorno(:,:,:,1,:),Condiciones_Contorno(:,:,:,2,:),Condiciones_Contorno(:,:,:,3,:),YminusOne,"Outputs",OutLayerNames);

    case 2
        [Yn0,Yn1,state] = predict(net,Condiciones_Contorno(:,:,:,1,:),Condiciones_Contorno(:,:,:,2,:),Condiciones_Contorno(:,:,:,3,:),YminusOne,"Outputs",OutLayerNames);

    case 3 
        [Yn0,Yn1,Yn2,state] = predict(net,Condiciones_Contorno(:,:,:,1,:),Condiciones_Contorno(:,:,:,2,:),Condiciones_Contorno(:,:,:,3,:),YminusOne,"Outputs",OutLayerNames);
