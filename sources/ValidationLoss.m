function [loss,gradients,state,nanFlag] = ValidationLoss(net,...
...
switch params.Scales
    case 1
        [Y0,Y1,state] = predict(net,Condiciones_Contorno(:,:,:,1,:),Condiciones_Contorno(:,:,:,2,:),Condiciones_Contorno(:,:,:,3,:),YminusOne,"Outputs",OutLayerNames);

    case 2
        [Y0,Y1,Y2,state] = predict(net,Condiciones_Contorno(:,:,:,1,:),Condiciones_Contorno(:,:,:,2,:),Condiciones_Contorno(:,:,:,3,:),YminusOne,"Outputs",OutLayerNames);

    case 3 
        [Y0,Y1,Y2,Y3,state] = predict(net,Condiciones_Contorno(:,:,:,1,:),Condiciones_Contorno(:,:,:,2,:),Condiciones_Contorno(:,:,:,3,:),YminusOne,"Outputs",OutLayerNames);

    case 4
        [Y0,Y1,Y2,Y3,Y4,state] = predict(net,Condiciones_Contorno(:,:,:,1,:),Condiciones_Contorno(:,:,:,2,:),Condiciones_Contorno(:,:,:,3,:),YminusOne,"Outputs",OutLayerNames);
    otherwise
